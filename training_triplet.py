...
from networks import EmbeddingNetL2, TripletNet, FaceModel
...
parser.add_argument('--resume',
                    default='./pytorch_face_logs/run-optim_adagrad-n1000000-lr0.1-wd0.0-m0.5-embeddings256-msceleb-alpha10/checkpoint_1.pth',
